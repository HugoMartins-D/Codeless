...
export const StaggeredMenu = ({
  ...
  const buildOpenTimeline = useCallback(() => {
    ...
    // Fade the colorful layers out once the glass panel settles, so the
    // blur reveals the real page content behind it instead of a solid tint.
    if (layers.length) {
      tl.to(
        layers,
        { opacity: 0, duration: 0.4, ease: "power2.out" },
        panelInsertTime + panelDuration - 0.1
      );
    }
