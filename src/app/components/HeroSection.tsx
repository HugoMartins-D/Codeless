...
function HeroVisual() {
  return (
    <div className="relative flex items-center justify-center" style={{ width: 560, height: 580 }}>
      ...
      {/* ── Central logo ── */}
      <div className="relative z-10" style={{ width: 260, height: 305 }}>
        {/* Logo glow halo */}
        ...
        <svg className="w-full h-full drop-shadow-2xl" fill="none" viewBox="0 0 355.3 415.573">
          <path d={svgPaths.p14637e00} fill="white" fillOpacity={0.95} />
          <path d={svgPaths.pa887200}  fill="white" fillOpacity={0.95} />
          <path d={svgPaths.p3245f980} fill="white" fillOpacity={0.95} />
        </svg>
      </div>
