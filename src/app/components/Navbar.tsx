  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "py-3" : "py-5"}`}>
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-center">
        ...
        {/* Pill — liquid glass com logo + links */}
        <div
        ...
        >
          ...
          <button onClick={() => go("#home", "Home")} className="focus:outline-none px-3">
            <img src="/logobranca.png" style={{ height: "20px", width: "auto" }} alt="Logo" />
          </button>
        ...
        {/* Mobile toggle */}
        <button className="md:hidden text-white ml-auto" onClick={() => setOpen(v => !v)}>
