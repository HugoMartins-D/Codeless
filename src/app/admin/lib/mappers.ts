...
export const fromContractRow = (r: any): Contract => ({
  ...
  clientRepresentatives: r.client_representatives ?? (r.client_representative ? [{ name: r.client_representative, cpf: "" }] : []),
  projectObject: r.project_object ?? "",
  paymentType: r.payment_type ?? "dinheiro",
  installmentType: r.installment_type ?? "integral",
  ...
  permutaDescription: r.permuta_description ?? undefined,
...
export const toContractRow = (c: Contract) => ({
  ...
  client_representative: c.clientRepresentatives[0]?.name ?? "",
  client_representatives: c.clientRepresentatives,
  project_object: c.projectObject,
  payment_type: c.paymentType,
  installment_type: c.installmentType,
  ...
  permuta_description: c.permutaDescription || null,
